...
class DealController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'background_from_color' => 'required|string|max:7',
            'background_to_color' => 'required|string|max:7',
            'is_active' => 'boolean',
        ...
        $deal = Deal::create([
            ...
            'background_from_color' => $request->background_from_color,
            'background_to_color' => $request->background_to_color,
