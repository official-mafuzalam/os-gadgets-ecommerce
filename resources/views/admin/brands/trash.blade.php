                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            <form action="{{ route('admin.brands.restore', $brand->id) }}"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    onclick="return confirm('Restore this brand?')" title="Restore">
                                            ...
                                            <!-- Permanently Delete -->
                                            <form action="{{ route('admin.brands.force-delete', $brand->id) }}"
                                                method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="text-red-600 hover:text-red-900 transition-colors p-1 rounded hover:bg-red-50 dark:hover:bg-red-900/20"
                                                    onclick="return confirm('This will permanently delete the brand. Are you sure?')"
